...
set name1 [lindex [split [info script] "."] 0]
set tracefd [open $name1.tr w]
set namtrace [open $name1.nam w]
...
proc finish {} {
#extra name variable
	global ns tracefd namtrace name1
	$ns flush-trace
	close $tracefd
	close $namtrace
	exec nam $name1.nam &
	exec awk -f exp8.awk $name1.tr > dsdv.dat &
	exit 0
}
$ns run
